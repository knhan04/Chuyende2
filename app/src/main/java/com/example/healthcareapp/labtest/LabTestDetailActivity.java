...
public class LabTestDetailActivity extends AppCompatActivity {
  ...
  Button btnAddtoCart,btnBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv2.setText("Chi phí: "+it.getStringExtra( "text3")+" VNĐ");
        ...
        btnAddtoCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(db.checkCart(username,product)==1){
                    Toast.makeText(getApplicationContext(),"Sản phẩm đã được thêm vào",Toast.LENGTH_SHORT).show();
                }else{
                    db.addtoCart(username,product,price,"lab test");
                    Toast.makeText(getApplicationContext(),"Bản ghi đã được thêm vào giỏ hàng thành công!",Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(LabTestDetailActivity.this,LabTestActivity.class));
